            ...
            <div className="space-y-6 mt-4">
              ...
              <div>
                ...
                <div className="space-y-2 pl-7">
                  ...
                  {(selectedItem.probation_discount ?? 0) > 0 && (
                    <div className="flex justify-between items-start py-1 gap-4">
                      <span className="text-sm flex-1 min-w-0">
                        ...
                        <span className="block text-xs text-muted-foreground">
                          Áp dụng {Math.round(((selectedItem.probation_rate ?? 0)) * 100)}% lương cho{" "}
                          {(selectedItem.probation_paid_days ?? 0).toFixed(2)} ngày công trước ngày chính thức
                        </span>
                      </span>
                      <span className="text-sm text-red-600 whitespace-nowrap tabular-nums">
                        -{formatCurrency(selectedItem.probation_discount ?? 0)}
                      </span>
                    </div>
                  )}
