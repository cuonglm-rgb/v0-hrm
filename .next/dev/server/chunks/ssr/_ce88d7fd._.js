...
async function listAllSalaries() {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    // Lấy lương mới nhất của mỗi nhân viên
    const { data, error } = await supabase.from("salary_structure").select("*").order("effective_date", {
        ascending: false
    });
    if (error) {
        console.error("Error listing all salaries:", error);
        return [];
    }
    // Lọc chỉ lấy record mới nhất của mỗi employee
    const latestSalaries = new Map();
    for (const salary of data || []){
        if (!latestSalaries.has(salary.employee_id)) {
            latestSalaries.set(salary.employee_id, salary);
        }
    }
    return Array.from(latestSalaries.values());
}
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(listAllSalaries, "00592a6d18c1477b17f4decbea66cd09d834dfd0dd", null);
...
"[project]/.next-internal/server/app/dashboard/salary/page/actions.js { ACTIONS_MODULE0 => \"[project]/lib/actions/employee-actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/lib/actions/payroll-actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/dashboard/salary/page/actions.js { ACTIONS_MODULE0 => \"[project]/lib/actions/employee-actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/lib/actions/payroll-actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "00592a6d18c1477b17f4decbea66cd09d834dfd0dd",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$payroll$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["listAllSalaries"],
    "005e20e2e268d812762b030e4aac3b7693066871b6",
